...
function ToWriteCard({
  ...
  const CopyBtn = ({ text, field }: { text: string; field: string }) => (
    <button
      ...
      style={{
        background: copiedKey === `${item.id}-${field}` ? "#d4f5e9" : "#ddd5c4",
        color: copiedKey === `${item.id}-${field}` ? "#1a7a4a" : "#7a5518",
      }}
    >
    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5 flex-wrap mt-0.5">
            ...
            {item.productCategory === "promocao" && (
              <span
                className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-full text-xs font-bold shrink-0"
                style={{
                  background: "#fde8e8",
                  color: "#c0392b",
          ...
          <div className="flex items-center gap-2 flex-wrap mt-0.5">
            <span
              ...
              style={{ background: "#ede8de", color: "#8a6520" }}
            >
        ...
        <div className="shrink-0">
          {expanded ? (
            <ChevronUp className="w-4 h-4" style={{ color: "#737390" }} />
          ) : (
            <ChevronDown className="w-4 h-4" style={{ color: "#737390" }} />
          )}
        </div>
      </button>
      ...
      {expanded && (
        <div
          ...
          style={{ borderTop: "1px solid #ddd5c4" }}
        >
          <div className="space-y-2 pt-3">
            ...
            >
              ...
              <CopyBtn
                text={formatBirthDate(item.clientBirthDate)}
                field="birth"
              />
            </div>
            {item.clientPhone && (
            ...
            <button
              ...
              style={{
                background:
                  copiedKey === `${item.id}-all` ? "#d4f5e9" : "#ede8de",
                color: copiedKey === `${item.id}-all` ? "#1a7a4a" : "#6b4c18",
            ...
            >
              {copiedKey === `${item.id}-all` ? (
                ...
                <>
                  <ClipboardList className="w-4 h-4" /> Copiar Todos os Dados
                </>
              )}
            </button>
          </div>
              ...
              >
                ...
                >
                  <span
                    ...
                    style={{ color: "#2a2a40" }}
                  >
                    {history.totalPurchases} trabalho
                    {history.totalPurchases !== 1 ? "s" : ""} no total
                  </span>
                </div>
                {history.purchases.length === 0 && (
                  <p className="px-4 py-3 text-xs" style={{ color: "#737390" }}>
                    ...
                    (p: {
                      ...
                      >
                        ...
                        <span
                          ...
                          style={{
                            background:
                              p.workStatus === "feito" ? "#d4f5e9" : "#ede8de",
                            color:
                              p.workStatus === "feito" ? "#1a7a4a" : "#8a6520",
                          }}
                        >
                          {p.workStatus === "feito"
                            ? "Feito"
                  ...
                  {(history as any).consultas.map(
                    (c: {
                      ...
                      <div
                        key={c.id}
                        className="px-4 py-2.5 flex items-center justify-between gap-2"
                        style={{ borderBottom: "1px solid #e4e4f4" }}
                      >
                        <p
                        ...
                        <span
                          className="text-xs px-2 py-0.5 rounded-full shrink-0"
                          style={{ background: "#e0e0f8", color: "#4040b0" }}
                        >
                          {c.consultationDate
          ...
          {!confirming ? (
            <button
              ...
              style={{
                background: "linear-gradient(135deg, #2060c0, #2878d0)",
              }}
            >
            ...
            <div className="space-y-2">
              <p
                ...
                style={{ color: "#2a2a40" }}
              >
                Confirmar que foi escrito?
              </p>
              <div className="flex gap-2">
                <button
                  onClick={() => {
                    onMarkWritten(item.id);
                    setConfirming(false);
                  }}
    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5 flex-wrap mt-0.5">
            <p className="text-xs truncate" style={{ color: "#737390" }}>
              {item.productName}
              {item.sellerName ? ` • ${item.sellerName}` : ""}
            </p>
            {item.productCategory === "promocao" && (
...
function DoneCard({
  ...
  return (
    <div
      className="rounded-2xl overflow-hidden shadow-sm"
      style={{ background: "white", border: "1.5px solid #c0e8d0" }}
    >
...
export default function ConsultoraPage() {
  ...
  const markWritten = trpc.consultora.markWritten.useMutation({
    onSuccess: () => {
      toast.success("Marcado como escrito! Movido para Pendentes.");
      invalidateAll();
    },
  ...
  const tabs = [
    {
      ...
      count: counts?.para_escrever ?? 0,
    },
    {
      id: "pendente" as Tab,
      label: "Pendentes",
      icon: <Hourglass className="w-4 h-4" />,
      count: counts?.pendente ?? 0,
    },
    {
      id: "feito" as Tab,
      label: "Feitos",
          ...
          {tabs.map(tab => (
            ...
            >
              <div className="flex items-center gap-1">
                ...
                {tab.count > 0 && (
                  <span
                    className="min-w-[18px] h-[18px] rounded-full text-xs flex items-center justify-center font-bold px-1"
                    style={{
                      background:
                        activeTab === tab.id
                          ? tab.id === "para_escrever"
                            ? "#c17f24"
                            : tab.id === "pendente"
                              ? "#c0392b"
                              : "#1a7a4a"
            ...
            {activeTab === "alertas" &&
              ((alertItems as any[]).length === 0 ? (
                <EmptyState
                  ...
                  sub="Todos os trabalhos estão dentro do prazo"
                />
              ) : (
                <div className="space-y-3">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    >
                      <RefreshCw
                        className={`w-3 h-3 ${isFetchingAlerts ? "animate-spin" : ""}`}
                      />
                      Atualizar
                    </button>
                  </div>
                      ...
                      >
                        <div className="flex items-start justify-between gap-2 flex-wrap">
                          <div className="flex-1 min-w-0 space-y-1">
                            ...
                            <p className="text-xs" style={{ color: "#8a6520" }}>
                              {item.productName}
                              {item.productCategory === "promocao"
                                ? " ⭐"
                                : item.productCategory === "coletivo"
                          ...
                          <div className="text-right shrink-0">
                            ...
                            <p
                              ...
                              style={{
                                color: item.isOverdue ? "#c0392b" : "#b7770d",
                              }}
                            >
...
function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      <div className="mb-3" style={{ color: "#c4a96a" }}>
        {icon}
      </div>
      <p className="text-sm font-medium" style={{ color: "#2a2a40" }}>
        {text}
      </p>
      <p className="text-xs mt-1 text-center" style={{ color: "#737390" }}>
        {sub}
      </p>
    </div>
  );
