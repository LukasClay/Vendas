...
import { Calendar, Clock, Plus, Trash2, Loader2, User, Phone, CalendarDays, CheckCircle2, ClipboardList } from "lucide-react";
...
function ConsultaCard({ slot, showDate = true }: {
  slot: {
    id: number;
  ...
  return (
    <div
      ...
      style={{ background: "white", border: "1px solid oklch(0.88 0.012 65)" }}
    >
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          >
            <Clock className="w-5 h-5" style={{ color: "oklch(0.55 0.18 280)" }} />
          </div>
          <div>
            {showDate && (
              <p className="text-xs font-semibold mb-0.5" style={{ color: "oklch(0.55 0.18 280)" }}>
                ...
                <div>
                  ...
                  <select
                    ...
                    style={{
                      border: "1.5px solid oklch(0.88 0.012 65)",
                      background: "oklch(0.98 0.006 65)",
                      color: newTime ? "oklch(0.15 0.02 260)" : "oklch(0.60 0.01 260)",
                    }}
                  >
