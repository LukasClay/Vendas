...
import { getSaleAttachmentFiles, getSaleClientPhotos } from "@/lib/saleMedia";
              ...
              <div className="mt-4 space-y-2">
                <div className="flex items-center justify-between gap-3">
                  <p className="text-[10px] font-bold uppercase tracking-wider text-[var(--muted-foreground)]">
                    Comprovantes adicionais ({attachmentCount}/
                    {MAX_TOTAL_ATTACHMENTS})
                  </p>
                  <button
                    type="button"
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-dashed border-[var(--border)] bg-[var(--secondary)] text-xs font-semibold text-[var(--muted-foreground)] hover:border-[var(--primary)] hover:text-[var(--primary)] transition-all disabled:opacity-50"
                  >
                      ...
                      {keptExtraPhotoItems.map((photo, index) => (
                        <div key={photo.id} className="relative">
                          ...
                          <button
                            ...
                            className="absolute -top-1.5 -right-1.5 p-1 rounded-full bg-red-500 text-white shadow-md"
                          >
                            <X className="w-3 h-3" />
                          </button>
                        </div>
