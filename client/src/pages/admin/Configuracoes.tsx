        ...
        <FadeIn>
          <div className="mb-8">
            ...
            <p className="text-sm mt-1" style={{ color: "var(--muted-foreground)" }}>
              Seu perfil e informaÃ§Ãµes do sistema
            </p>
          </div>
        </FadeIn>
        ...
        <StaggerList className="space-y-4">
            ...
            <div className="rounded-2xl p-6 shadow-xl" style={{ background: "var(--card)", border: "1px solid var(--border)" }}>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center py-2 border-b" style={{ borderColor: "var(--border)" }}>
                  <span className="text-sm" style={{ color: "var(--muted-foreground)" }}>Nome</span>
                  <span className="text-sm font-medium" style={{ color: "var(--foreground)" }}>{user?.name || "â€”"}</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b" style={{ borderColor: "var(--border)" }}>
                  <span className="text-sm" style={{ color: "var(--muted-foreground)" }}>Email</span>
                  <span className="text-sm font-medium" style={{ color: "var(--foreground)" }}>{user?.email || "â€”"}</span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="text-sm" style={{ color: "var(--muted-foreground)" }}>NÃ­vel de acesso</span>
          ...
          <StaggerItem>
            <div className="rounded-2xl p-6 shadow-xl" style={{ background: "var(--card)", border: "1px solid var(--border)" }}>
              ...
              <div className="space-y-3">
                {[
                  ["Sistema", "GestÃ£o de Vendas Espirituais"],
                  ["VersÃ£o", "2.6.0"],
                  ["Banco de Dados", "PostgreSQL"],
                  ["Armazenamento", "10GB/mÃªs"],
                ].map(([label, value]) => (
          ...
          <StaggerItem>
            <div className="rounded-2xl p-6 shadow-xl" style={{ background: "var(--card)", border: "1px solid var(--border)" }}>
              <div className="flex items-center gap-3 mb-3">
                ...
                <h2 className="font-bold" style={{ color: "var(--foreground)" }}>RelatÃ³rios AutomÃ¡ticos</h2>
              </div>
              <p className="text-sm" style={{ color: "var(--muted-foreground)" }}>
                Configure o envio automÃ¡tico de relatÃ³rios por email na pÃ¡gina de{" "}
                <a href="/admin/relatorios" className="font-semibold underline" style={{ color: "var(--primary)" }}>
                  RelatÃ³rios
                </a>.
                VocÃª pode configurar envios diÃ¡rios, semanais e mensais para qualquer email.
              </p>
            </div>
          </StaggerItem>
        </StaggerList>
