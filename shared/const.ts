...
// Limites de mídia por venda — compartilhados entre cliente (UX) e servidor (segurança).
// ADM é o único que consegue ultrapassar os limites de Vendedor/Consultora via edição.
